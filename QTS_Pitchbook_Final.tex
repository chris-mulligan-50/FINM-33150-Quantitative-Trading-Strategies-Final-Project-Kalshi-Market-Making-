...
\begin{frame}[shrink=5]{Leverage \& Shorting Logic}
  ...
  \begin{alertblock}{Leverage Policy}
    \small Leverage is used for the delta-hedging leg (SPY short margin), while intentionally not applying leverage to the Kalshi book itself. Market-making profit does not scale with capital.
  \end{alertblock}
\end{frame}
